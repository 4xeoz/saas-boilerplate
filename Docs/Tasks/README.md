...
| [CR-TASK-005](CR-TASK-005-cover-standing-consent-handoff.md) | Cover the implemented standing Consent handoff at the renderer and HTTP boundaries. | Add focused namespace, login, expiry, redaction, same-user decision, and popup-origin coverage before treating the page contract as independently verified. |
