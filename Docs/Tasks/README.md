...
|---|---|---|
| [CR-TASK-001](CR-TASK-001-reconcile-core-source-identity.md) | Integrate the accepted Core source boundary and complete its compatibility evidence. | Integrated source identity, standing/process scenarios, and exact-source upgrade pass; compatibility and release remain open. |
| [CR-TASK-002](CR-TASK-002-run-disposable-database-verification.md) | Integrate the verified existing PostgreSQL baseline and complete missing coverage. | 203 backend tests and exact-source upgrade pass on the integrated commit; deployment/release remain open. |
...
| [CR-TASK-005](CR-TASK-005-cover-standing-consent-handoff.md) | Cover the implemented standing Consent handoff at the renderer and HTTP boundaries. | 13 real HTTP/database integration cases pass and are integrated; real-browser and hosted continuation remain open. |
